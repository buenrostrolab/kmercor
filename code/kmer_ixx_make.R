...
bed <- "../liftover/ImmGen_mm9.bed"   # Point to new bed file with peaks
peaks <- get_peaks(bed, sort_peaks = FALSE)

kmer_idx <- get_kmer_indices(peaks, genome = BSgenome.Mmusculus.UCSC.mm9, k = 5)
...
saveRDS(ixx, "../output/kmer.mm9.ixx.rds")
